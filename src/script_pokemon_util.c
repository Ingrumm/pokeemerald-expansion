...
u32 ScriptGiveMon2(u16 species, u8 level, u8 hpIv, u8 atkIv, u8 defIv, u8 spatkIv, u8 spdefIv, u8 speedIv, u8 nature)
{
    u8 evs[NUM_STATS]        = {0, 0, 0, 0, 0, 0};
    u16 moves[MAX_MON_MOVES] = {MOVE_NONE, MOVE_NONE, MOVE_NONE, MOVE_NONE};
    u8 ivs[NUM_STATS]        = {hpIv, atkIv, defIv, spatkIv, spdefIv, speedIv};

    return ScriptGiveMonParameterized(0, PARTY_SIZE, species, level, ITEM_NONE, ITEM_POKE_BALL, nature, NUM_ABILITY_PERSONALITY, MON_GENDERLESS, evs, ivs, moves, FALSE, FALSE, NUMBER_OF_MON_TYPES, 0);
}
